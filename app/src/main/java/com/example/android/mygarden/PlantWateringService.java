...
// https://github.com/udacity/AdvancedAndroid_MyGarden/compare/TWID.03-Exercise-UpdateWidgetsService...TWID.03-Solution-UpdateWidgetsService
/**
...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        Cursor cursor = getContentResolver().query(
                ...
                null,
                null,
                PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME    // sort by
        );
