...
//
// simply creates & returns RemoteViewsFactory in the constructor
...
class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        // Cursor to get all plant info ordered by creation time
    ...
    public RemoteViews getViewAt(int position) {
        ...
        // Fill in the onClick PendingIntentTemplate using the specific plant Id for each item individually
        Bundle extras = new Bundle();
        extras.putLong(PlantDetailActivity.EXTRA_PLANT_ID, plantId);
        Intent fillInIntent = new Intent();
        fillInIntent.putExtras(extras);
        // you can customize each item using FillInIntent, it allows you to pass extra data to PendingIntentTemplate
